...
def extract(emb_image, passcode):
    ...
    indx =30
    temp = []
    file_handle = open('d:/temp1/' + file_name, 'wb')
...
def main():
    embed('d:/python/project/steganography/snake.jpg', 'd:/python/project/steganography/new_snake.png', 'd:/python/project/certificate.jpg', 'apple9')
